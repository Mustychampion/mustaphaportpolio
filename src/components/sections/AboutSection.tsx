...
export function AboutSection({ bio }: AboutSectionProps) {
  ...
  const defaultBio = `As the CEO of ValorTrust Solution & Consultant Nig. Ltd, I bring a unique blend of entrepreneurial vision and technical expertise in Quantity Surveying. Currently pursuing my professional education, I am committed to delivering exceptional value in cost management, project consulting, and construction economics.
